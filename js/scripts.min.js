 ...
 * Copyright (c) 2018 JГ¶rn Zaefferer; Licensed MIT */
...
$(function() {
    ...
    $('#ask_form').submit(function(){
        ...
        content += '<p><strong>Name:</strong> '+$('#ask_form input[name="name"]').val()+'</p>';
        content += '<p><strong>Email:</strong> '+$('#ask_form input[name="email"]').val()+'</p>';
        content += '<p><strong>Message:</strong> '+$('#ask_form textarea').val()+'</p>';

        Email.send(
            "simoarsimoarar@gmail.com",
            "petreniuk.ua@gmail.com",
            "Ask a question",
            content,
            {
                token: "72933e94-a643-49f4-a424-e0aee6ae5748",
                callback: function done(message) { $('#thank-you').modal(); }
            },
